...
// MQTT settings
char mqttServer[]     = "192.168.43.97";
int  mqttPort         = 1883;
char mqttClientName[] = "192.168.43.8";
char mqttUsername[]   = "";       // your MQTT username
char mqttPassword[]   = "";       // your MQTT password
char mqttTopic[]      = "led/switch/device1";  // your MQTT topic /<username>/topic
...
int wifiStatus        = 1;  // the Wifi radio's status
